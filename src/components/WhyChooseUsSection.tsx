  ...
  const benefits = [
    {
      ...
      description:
        "No middlemen involved. Get the best prices directly from our manufacturing unit with guaranteed authenticity and freshness.",
      color: "text-blue-600",
      bgColor: "bg-blue-100",
    },
    {
      ...
      description:
        "Competitive wholesale rates with attractive margins for distributors. Volume discounts available for larger orders.",
    ...
    },
    {
      ...
      description:
        "ISO certified manufacturing process ensures every batch meets the highest standards of quality, fragrance, and burn time.",
    ...
    },
    {
      ...
      description:
        "Over 50 unique fragrances including traditional, floral, woody, and wellness variants to cater to diverse customer preferences.",
          ...
          {benefits.map((benefit, index) => (
            ...
            >
              <CardContent className="p-8">
                <div
                  className={`w-20 h-20 ${benefit.bgColor} rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-smooth`}
                >
